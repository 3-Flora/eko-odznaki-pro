...
export default function EditChallengePage() {
  ...
  const loadChallenge = async () => {
    try {
      ...
      if (!challenge) {
        showError("EkoWyzwanie nie zostało znalezione");
      ...
      showError("Nie udało się załadować EkoWyzwania");
      navigate("/ekoskop/challenges");
    } finally {
      setIsLoading(false);
    }
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showSuccess("EkoWyzwanie zostało zaktualizowane pomyślnie!");
      navigate("/ekoskop/challenges");
    } catch (error) {
      console.error("Error updating challenge:", error);
      showError("Nie udało się zaktualizować EkoWyzwania");
    } finally {
  ...
  return (
    <div className="space-y-6">
      <PageHeader
        ...
        subtitle="Wprowadź zmiany w wybranym wyzwaniu"
      />
